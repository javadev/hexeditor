...
class binEdit extends JComponent implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, ActionListener, AdjustmentListener {
         ...
         if(this.lastPos <= this.virtualSize) {
            ...
            try {
               if(var3 == 0) {
                  ...
                  var7 = this.topPanel.fForm.format((double)Float.intBitsToFloat((new BigInteger(var1)).intValue()));
               } else if(var3 == 9) {
                  ...
                  var7 = new String(var1, this.topPanel.viewCBox[0].getSelectedIndex() < 1?"UTF-16BE":"UTF-16LE");
               } else {
   ...
   public void KeyFromMenu(int var1) {
      ...
      case 89:
         ...
         break;
      case 90:
         if(!var4 && !this.undoStack.empty() && (1 < this.undoStack.size() || 1 == this.undoStack.size() && 2 < ((edObj)this.undoStack.lastElement()).a1)) {
